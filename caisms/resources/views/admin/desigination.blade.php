...
<br><br>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="{{ route('adddesiginationMaster') }}" method="post" class="form-horizontal"  id="form_submit" autocomplete="off" enctype="multipart/form-data">
     @csrf
