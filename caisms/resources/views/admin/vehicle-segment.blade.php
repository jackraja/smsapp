...
<br><br>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="{{ route('addvehiclesegmentMaster') }}" method="post" class="form-horizontal"  id="form_submit" autocomplete="off" enctype="multipart/form-data">
     @csrf
...
jQuery('#form_submit').validate({
    ...
    $(document).ready(function () {
        ...
        $('#data-table-basic').DataTable({
            ...
            "destroy": true,
            "ajax":{
                     "url": "{{url('allvehiclesegmentMaster')}}",
                     "dataType": "json",
                     "type": "post",
